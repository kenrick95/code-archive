// FROM http://www.inf.ethz.ch/personal/gaertner/miniball.html
// modified; this can solve problem 5 of CEC Hackathon 2014
// but most of this is not my code, will I be considered cheating if I submit this?
//
...
int main (int argc, char* argv[])
{
  ...
  int             d = 2;            // dimension
    while (scanf("%d", &n) != EOF) {
      ...
      printf("%.2f %.2f %.2f\n", center[0], center[1], sqrt(mb.squared_radius()));
