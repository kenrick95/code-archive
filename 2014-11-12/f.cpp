...
int main(){
    ...
    while (scanf("%d %d", &n, &c) != EOF) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (0 <= dres1 && dres1 <= 1
                && 0 <= dres2 && dres2 <= 1) {
                // city to pipe: straight line perpendicular to pipe
                ...
                // city to pipe: straight line to end of pipe
                min_dist[i][0] = min(dist1, dist2);
            }
            //printf("%lf\n", min_dist[i][0]);
            //printf("\n");
            ...
            if (0 <= dres1 && dres1 <= 1
                && 0 <= dres2 && dres2 <= 1) {
                // city to pipe: strbight line perpendiculbr to pipe
